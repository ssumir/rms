      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">স্বাগতম পার্কস ড্যাশবোর্ডে - Select a service to continue</p>
          </div>
  ...
  const ServiceAgeCalculator: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-12 px-4">
        {/* ...Rest of the JSX remains unchanged, use benefitInfo! */}
      </div>
    );
  };
...
//               <FaHome className="w-6 h-6 text-blue-600" />
//             </div>
//             <h1 className="text-2xl font-bold">Perks Management System</h1>
//           </div>
//           {currentPage !== 'dashboard' && (
//             <button
//               onClick={() => setCurrentPage('dashboard')}
...
//               Welcome to Perks Dashboard
//             </h2>
//             <p className="text-lg text-gray-600">
//               স্বাগতম পার্কস ড্যাশবোর্ডে - Select a service to continue
//             </p>
//           </div>
...
// //       if (!formData.serviceYears) newErrors.serviceYears = 'Service years required';
// //       if (!formData.basicSalary || formData.basicSalary <= 0) newErrors.basicSalary = 'Basic salary required';
// //       return newErrors;
// //     };
...
// //             </h2>
// //             <p className="text-gray-600">চূড়ান্ত নিষ্পত্তি ফর্ম</p>
// //           </div>

// //           {submitted && (
// //             <div className="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
// //               ✓ Settlement form submitted successfully! / সফলভাবে জমা হয়েছে!
// //             </div>
// //           )}
...
// //                 />
// //                 {errors.serviceYears && (
// //                   <p className="text-red-500 text-xs mt-1">{errors.serviceYears}</p>
// //                 )}
// //               </div>
...
// //             >
// //               Submit Settlement Form / ফর্ম জমা দিন
// //             </button>
// //           </div>
// //         </div>
// //       </div>
...
//             ].map((service, idx) => (
//               <div key={idx} className={`bg-${service.color}-50 border-2 border-${service.color}-200 p-6 rounded-xl hover:shadow-lg transition-shadow`}>
//                 <h3 className={`text-xl font-bold text-${service.color}-800 mb-2`}>{service.title}</h3>
